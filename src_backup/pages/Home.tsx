...
import { Search, MapPin, Navigation, Bell, ChevronDown, Clock, Bus } from 'lucide-react'
          ...
          <div>
            ...
            <div className="space-y-3">
              {activeBuses.map((bus) => (
                <Card
                  key={bus.id}
                  onClick={() => navigate(`/tracking/${bus.user_id}`)}
                  className="p-4 shadow-card bg-gradient-card border-l-4 border-l-green-500 cursor-pointer hover:shadow-lg transition-transform active:scale-[0.98]"
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
