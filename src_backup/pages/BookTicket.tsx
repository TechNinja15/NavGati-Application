...
export default function BookTicket() {
  ...
  const calculateFare = () => {
    if (!boardingStop || !droppingStop) return 0
  ...
  const handleBookTicket = () => {
    if (!boardingStop || !droppingStop || !selectedPayment) return
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="px-4 py-6 space-y-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <Select value={boardingStop} onValueChange={setBoardingStop}>
              ...
              <SelectContent>
                {routeStops.map((stop) => (
                  <SelectItem key={stop} value={stop} disabled={stop === droppingStop}>
          ...
          <div>
            ...
            <Select value={droppingStop} onValueChange={setDroppingStop}>
              ...
              <SelectContent>
                {routeStops.map((stop) => (
                  <SelectItem key={stop} value={stop} disabled={stop === boardingStop}>
                    <div className="flex items-center space-x-2">
                      <MapPin className="h-4 w-4 text-muted-foreground" />
                      <span>{stop}</span>
                    </div>
        ...
        <Button 
          ...
          disabled={!boardingStop || !droppingStop || !selectedPayment}
        >
          Book Ticket - ₹{fare}
        </Button>
      </div>
