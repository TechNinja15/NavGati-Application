      ...
      <Card className="w-full max-w-md p-6 shadow-card bg-gradient-card">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <Input id="driverId" type="text" placeholder="Enter your Driver ID" value={driverId} onChange={(e) => setDriverId(e.target.value)} required/>
          </div>
        ...
        <div className="space-y-3">
          <Button variant="outline" className="w-full border-primary/20 hover:bg-primary/5 h-12" onClick={handlePassengerAccess}>
            <User className="h-4 w-4 mr-2"/>
            Continue as Passenger
          </Button>
          <Button variant="outline" className="w-full border-primary/20 hover:bg-primary/5 h-12" onClick={handleStudentAccess}>
