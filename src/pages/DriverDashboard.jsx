      ...
      <Card className="p-4 shadow-card">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <Button onClick={() => setFilledSeats(Math.max(0, filledSeats - 1))} variant="outline" size="sm" disabled={filledSeats === 0} className="h-8 w-8 p-0">
                -
              </Button>
              <Badge variant="secondary" className="px-2 py-1 text-sm">
                {filledSeats}
              </Badge>
              <Button onClick={() => setFilledSeats(Math.min(parseInt(totalSeats), filledSeats + 1))} variant="outline" size="sm" disabled={filledSeats >= parseInt(totalSeats)} className="h-8 w-8 p-0">
                +
              </Button>
            </div>
          </div>
